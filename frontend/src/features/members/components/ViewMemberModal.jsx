      ...
      <div className="relative w-full max-w-md rounded-2xl bg-surface p-6 shadow-2xl">
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <span className={`inline-flex mt-1 rounded border px-2 py-0.5 text-xs font-semibold capitalize ${ROLE_BADGE[member.role] ?? "bg-muted/10 border-muted/20 text-muted"}`}>
              {member.role ?? "member"}
            </span>
          </div>
        </div>
