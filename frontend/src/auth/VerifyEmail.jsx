    ...
    <AuthLayout>
      ...
      >
        ...
        <div className="flex flex-col gap-1 ">
          <h1 className="text-2xl font-bold text-[#111827]">Verify Email</h1>
        ...
        >
          <p className="text-center text-black/50">
            Enter the <span className="text-[#111827]">5 digits code</span> sent
            to your email <span className="text-[#111827]">{email}</span>
            below
          </p>
          <div className="flex gap-5">
            {[0, 1, 2, 3, 4].map((_, index) => (
              <input
                ...
                className="w-13 h-13 text-center  shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] rounded-md focus:ring-2 focus:ring-[#144DEF] focus:outline-none text-2xl text-[#144DEF]"
              />
            ))}
          </div>
          <p className="flex items-center justify-center gap-1 text-black/50 font-normal">
